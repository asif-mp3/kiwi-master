...
def validate_plan(plan: dict, schema_path=None):
    """
    ...
    # Resolve schema path if default
    if schema_path is None:
        # Resolves to backend/planning_layer/plan_schema.json
        schema_path = Path(__file__).parent.parent / "planning_layer" / "plan_schema.json"
