      ...
      <div className="absolute w-56 h-56 rounded-full">
        {audioLevels.map((level, i) => {
          ...
          return (
            ...
            >
              <div
                className={`w-full h-full rounded-full transition-colors duration-300 ${isRecording
          ...
          <>
            {[...Array(6)].map((_, i) => (
              <motion.div
                ...
                className={`absolute w-1.5 h-1.5 rounded-full ${isRecording ? 'bg-green-400' : 'bg-teal-400'
                  }`}
                style={{
